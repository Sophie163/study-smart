    ...
    return (         
      <>
        ...
        <div style={{ display: 'block', width: '100%', padding: 0 }} class="bg-mygreen">
          <p className='pt-5'>
          Sign In to start studying smart with our helpful tools<button type="gosignin" className="custom-secondary mb-3 ms-4"><a class="nav-link" href="/study-smart/#/SignIn">Sign In</a></button>
          </p>
        </div>
        ...
        <div class="container mb-4 p-4">
            <div class="row">
                ...
                <div class="col-sm-8 bg-white p-4 text-start">
                    ...
                    <button type="gotutors" className="custom-primary m-2"><a class="nav-link" href="/study-smart/#/Tutors">Find your Tutor</a></button>
                </div>
            </div>
        </div>
        <div class="container my-4 p-4">
            <div class="row">
                <div class="col-sm-8 bg-white p-4 text-start">
                    ...
                    <button type="goplanner" className="custom-primary m-2"><a class="nav-link" href="/study-smart/#/Planner">Start Planning</a></button>
                </div>
                <div class="col-sm-4 bg-black m-0 p-0">
        ...
        <div class="container my-4 p-4">
            <div class="row">
                ...
                <div class="col-sm-8 bg-white p-4 text-start">
                    ...
                    <button type="gotiming" className="custom-primary m-2"><a class="nav-link" href="/study-smart/#/Timer">Reach your Goals</a></button>
                </div>
            </div>
        </div>
        </>     
